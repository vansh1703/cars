...
export default async function CarsPage({ searchParams }: { searchParams: any }) {
  const [cars, brands] = await Promise.all([getCars(searchParams), getBrands()])
  ...
  function buildUrl(updates: Record<string, string>) {
    const params = new URLSearchParams({ brand, fuel, transmission, sort, ...updates })
    // remove empty
          ...
          <div className="bg-white rounded-sm shadow-sm p-5 sticky top-24">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-col gap-2">
                {[['', 'Newest First'], ['price_asc', 'Price: Low to High'], ['price_desc', 'Price: High to Low']].map(([val, label]) => (
