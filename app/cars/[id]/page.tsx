            ...
            <div className="sticky top-24">
              {!car.is_sold ? (
                ...
                <div className="bg-brand-navy rounded-sm p-6 text-center">
                  ...
                  <p className="text-gray-400 text-sm mb-4">
                    This car has been sold. Browse our other cars.
                  </p>
                  <Link href="/cars" className="btn-gold w-full justify-center">
                    View Available Cars
                  </Link>
                </div>
              )}
              <div className="bg-white rounded-sm p-4 mt-4 border border-gray-100 text-center">
                ...
                <a
                  ...
                  className="font-bold text-brand-navy text-lg hover:text-brand-gold transition-colors"
                >
                  +91 99999 99999
                </a>
  ...
  return (
    <div className="flex items-start gap-3 p-3 bg-brand-cream rounded-sm">
      ...
      <div>
        ...
        <div className="text-brand-navy font-semibold text-sm mt-0.5">
          {value}
        </div>
      </div>
    </div>
